...
class Touch extends React.Component {
    ...
    _onResponderMove=async (e)=>{
        ...
        this.refs.luokun.measure((ox, oy, width, height, px, py) => {
            if(locationY>0&&locationX>0&&locationY<height&&locationX<width){//手势移出范围后取消响应
                 ...
                 *
                 * @param e       Event from React Native
                 * @param offset  Absolute offset 绝对偏移量
                 * @param per     Relative Offset 相对(video宽度百分比)偏移量
                 * **/
                this.props.onResponderMove&&this.props.onResponderMove(e)
            }
        });
    };
    ...
    _onResponderRelease=(e)=>{
        ...
        return this.props.onResponderRelease&&this.props.onResponderRelease(e)
    };
